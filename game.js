// ATI STUDY RUNNER - Dynamic Question Game
// Questions are loaded from STUDY_DATA.gameQuestions (studyData.js)

// Reference to game questions from data file
const gameQuizQuestions = (typeof STUDY_DATA !== 'undefined' && STUDY_DATA.gameQuestions) 
  ? STUDY_DATA.gameQuestions 
  : [
    // Fallback questions if STUDY_DATA not loaded
    { q: "Loading questions...", options: ["Please refresh", "Check console", "Report issue"], correctAnswer: "Please refresh" }
  ];
